...
export default class BaseApi {
            ...
            try {
                ...
                axios(signed_config)
                    .then((resp) => {
                        ...
                        if (resp && resp.data && this.secret && this.getHeader(resp.headers, "x-payload") === "secure" && this.getHeader(resp.headers, "content-type") === "application/json" && resp.data["_payload_"]) {
    ...
    UPLOAD(token, url, values = {}, ids = {}) {
        ...
        keys.forEach((name) => {
            ...
            } else other_data[name] = values[name];
        });
